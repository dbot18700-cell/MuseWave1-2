...
class CentralEmbedHandler {
    ...
    async createCentralEmbed(channelId, guildId) {
        try {
            ...
            .setAuthor({ name: 'MuseWave Control Center', iconURL: 'https://cdn.discordapp.com/emojis/896724352949706762.gif', url: 'https://discord.gg/xQF9f9yUEM' })
                .setDescription([
                    '',
                ...
                .setFooter({ 
                    text: 'MuseWave • Developed By MAYUKH ADHIKARY!',
